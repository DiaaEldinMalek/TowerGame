...
void GUI::PrintMessage(string msg, string msg2, string msg3, string msg4) const	//Prints a message on status bar
{
    ClearStatusBar();	//First clear the status bar
